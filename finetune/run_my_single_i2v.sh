...
# export MODEL_PATH="/workspace/public/models/CogVideoX1.5-5B"
export MODEL_PATH="/workspace/public/models/CogVideoX1.5-5B-I2V"
export CACHE_PATH="~/.cache"
export DATASET_PATH="/workspace/public/datasets/Disney-VideoGeneration-Dataset"
